...
conf = {
    ...
    'sasl.username': 'DLM5XN6PGUKMX2XH',
    'sasl.password': 'Br5RVK1fsmE0qk4jo+ZDS15Mb4w85SZ2APerW6mtDnu8WqkMANLQvKQDiJ3xFRS3'
}
...
for data in test_data:
    for i in range(200):
        producer.produce(topic, key="250001", value= data.encode('utf-8'), callback=delivery_report)
        producer.poll(0)
